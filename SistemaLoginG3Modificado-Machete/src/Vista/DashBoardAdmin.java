...
public class DashBoardAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnRolUsuarios.setBackground(new java.awt.Color(102, 102, 255));
        ...
        panelMenu.add(btnProductos, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, 190, 30));
        ...
        getContentPane().add(panelEncabezado, new org.netbeans.lib.awtextra.AbsoluteConstraints(224, 0, 870, -1));

        panelContenido.setBackground(new java.awt.Color(255, 255, 255));
        panelContenido.setPreferredSize(new java.awt.Dimension(800, 560));
        panelContenido.setLayout(new java.awt.BorderLayout());
        getContentPane().add(panelContenido, new org.netbeans.lib.awtextra.AbsoluteConstraints(224, 80, 870, 600));
